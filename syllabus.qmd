...
-   Randi Garcia (`rgarcia@smith.edu`). Bass Hall 412. Randi's office hours will be held on Thursdays 2:45p-4:00p, Fridays 10:50a-12:05p, or by appointment.
...
3.  **Exams** \[20%\]: There will be two take home exams throughout the term. See the schedule for tentative dates of these exams. They will usually be distributed on a Tuesday and due that Friday. You will have time in class to work on the exams. **I will be dropping the lowest exam grade at the end of the term.**
...
The [course website](https://randilgarcia.github.io/sds290spring24/) will be regularly updated with lecture slides, project information, assignments, and other course resources. Assignments and grades will be submitted via Moodle. You should check both regularly.
